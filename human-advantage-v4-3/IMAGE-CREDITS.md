# Human Advantage v4.3 image credits

The six presentation PNG assets in this directory are stored locally for stable GitHub Pages delivery; the presentation does not hotlink external image sources.

## Existing deck assets

The four existing assets were carried forward unchanged from the approved v4.1 deck:

- `01-origin-journey.png` — generated image; prompt provenance retained in the originating task/session.
- `02-patient-promise.png` — generated image; prompt provenance retained in the originating task/session.
- `03-team-resilience.png` — generated image; prompt provenance retained in the originating task/session.
- `04-311-practice.png` — retained local asset for version continuity; no longer displayed by the v4.2 slide content.
...
The original cached source files were preserved; the repository contains copies named for their slide use.
